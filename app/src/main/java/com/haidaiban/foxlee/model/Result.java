...
public class Result {
    ...
    @Expose
    private Object extPayDesc;
    @SerializedName("ext_pay_acct")
    @Expose
    private Object extPayAcct;
     ...
     * The ext_pay_desc
     */
    public void setExtPayDesc(Object extPayDesc) {
     ...
     * The ext_pay_acct
     */
    public void setExtPayAcct(Object extPayAcct) {
