 ...
 *         Time:2015年3月22日
 */
public class Dialog_ShareOrder extends Dialog {
     ...
     *            样式
     */
    public Dialog_ShareOrder(Context context, int theme, int num) {
        super(context, theme);
        this.mContext = context;
        this.num = num;
    }

    public Dialog_ShareOrder(Context context) {
        ...
        tv_my_camera_take_photo
                .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mode = 0;
                        Dialog_ShareOrder.this.dismiss();
                        //拍照选择
